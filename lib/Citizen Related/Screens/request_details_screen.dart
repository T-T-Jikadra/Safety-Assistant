...
import 'package:fff/Citizen%20Related/Screens/user_feedback_screen.dart';
                                          ...
                                          Navigator.of(context).push(
                                            PageRouteBuilder(
                                              ...
                                              => User_Feedback_Screen(
                                                ...
                                                respond_id:widget.documentSnapshot['RespondId'] ),
                                              transitionsBuilder:
                                      ...
                                      Navigator.of(context).push(
                                        PageRouteBuilder(
                                          pageBuilder:
                                              (context, animation, secondaryAnimation) =>
                                              User_Feedback_Screen(
                                                authority_name: fetchedGid,
                                                authority_id: fetchedGovtName,
                                                respond_id: widget.documentSnapshot['RespondId']),
                                          transitionsBuilder:
                                              (context, animation, secondaryAnimation, child) {
                                            var begin = const Offset(1.0, 0.0);
