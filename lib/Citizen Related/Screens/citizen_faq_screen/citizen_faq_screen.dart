...
class Citizen_FAQ_Screen extends StatefulWidget {
  const Citizen_FAQ_Screen({super.key});

  @override
  State<Citizen_FAQ_Screen> createState() => _Citizen_FAQ_ScreenState();
}

class _Citizen_FAQ_ScreenState extends State<Citizen_FAQ_Screen> {
  @override
          ...
          child: Column(
            children: [
              ...
              FAQ(
                  ...
                  answer:
                      "Yes, You can give a feedback to the NGO or Government Bodies as per their servings. You can find option to give feedback \"Request History\" => click on the Request on you want to give feedback. Here you can find section for feedback "),
              FAQ(
              ...
              FAQ(
                  ...
                  answer:
                      "All Air details can be seen in the 'Alerts' section of the app."),
              FAQ(
                  question:
              ...
              FAQ(
                  question: "What is digital Survival guide ?",
                  answer:
                      "A Digital Survival guide is list of guidance which specify the what to do and not in situation of emergency."),
            ],
          ),
        ),
      ),
