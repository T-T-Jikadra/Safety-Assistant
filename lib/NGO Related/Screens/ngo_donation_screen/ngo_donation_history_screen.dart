...
import 'ngo_donation_details_screen.dart';
...
class _NGO_Donation_History_ScreenState
    extends State<NGO_Donation_History_Screen> {
  ...
  Future<void> fetchNGOData() async {
    try {
      ...
      if (citizenSnapshot.exists) {
        ...
        setState(() {
          fetchedNid = citizenSnapshot.get('nid');
          fetchedFname = citizenSnapshot.get('email');
        });
      } else {
        if (kDebugMode) {
