...
class Govt_FAQ_Screen extends StatefulWidget {
  const Govt_FAQ_Screen({super.key});

  @override
  State<Govt_FAQ_Screen> createState() => _Govt_FAQ_ScreenState();
}

class _Govt_FAQ_ScreenState extends State<Govt_FAQ_Screen> {
  @override
          ...
          child: Column(
            children: [
              FAQ(
                  ...
                  answer:
                      "A Registered email and Government Registration number is required for Login. After Entering these both field you need enter your password then after you can Login to the Application."),
              FAQ(
                  question:
