...
class Admin_Open_Feedback_Details_Screen extends StatefulWidget {
  final String fid;

  const Admin_Open_Feedback_Details_Screen({super.key, required this.fid});

  @override
  _Admin_Open_Feedback_Details_ScreenState createState() =>
      _Admin_Open_Feedback_Details_ScreenState();
}

class _Admin_Open_Feedback_Details_ScreenState
    extends State<Admin_Open_Feedback_Details_Screen> {
